...
func NewBrcovid19apiAPI(spec *loads.Document) *Brcovid19apiAPI {
	return &Brcovid19apiAPI{
		...
		GetCovid19ReportDataHandler: GetCovid19ReportDataHandlerFunc(func(params GetCovid19ReportDataParams) middleware.Responder {
			return middleware.NotImplemented("operation GetCovid19ReportData has not yet been implemented")
		}),
	}
}
...
func (o *Brcovid19apiAPI) Validate() error {
	...
	if o.GetCovid19ReportDataHandler == nil {
		unregistered = append(unregistered, "GetCovid19ReportDataHandler")
	}
...
func (o *Brcovid19apiAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/covid19"] = NewGetCovid19ReportData(o.context, o.GetCovid19ReportDataHandler)
}
