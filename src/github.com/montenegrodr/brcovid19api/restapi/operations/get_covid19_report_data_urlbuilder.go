...
func (o *GetCovid19ReportDataURL) WithBasePath(bp string) *GetCovid19ReportDataURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetCovid19ReportDataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetCovid19ReportDataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetCovid19ReportDataURL")
	}
